...
const aliasBox = document.getElementById('h_name')
const alias = document.getElementsByClassName('name')[0]
const alias1 = document.getElementsByClassName('name')[1]

aliasBox.addEventListener('mouseenter', () => {
    alias.classList.toggle('alias')
    alias1.classList.toggle('alias')
})
aliasBox.addEventListener('mouseleave', () => {
    alias.classList.toggle('alias')
    alias1.classList.toggle('alias')
})
aliasBox.addEventListener('touchstart', () => {
    alias.classList.toggle('alias')
    alias1.classList.toggle('alias')
})
aliasBox.addEventListener('touchend', () => {
    alias.classList.toggle('alias')
    alias1.classList.toggle('alias')
})
